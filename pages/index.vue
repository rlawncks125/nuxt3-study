<template>
  <div class="p-2">
    ...
    <div class="border py-20 my-2">aos</div>
    <div class="border py-20 my-2" data-aos="fade-up">aos</div>
    <div class="border py-20 my-2" data-aos="fade-left">aos</div>
    <div class="border py-20 my-2" data-aos="fade-zoom-in">aos</div>
    <div class="border py-20 my-2" data-aos="fade-right">aos</div>
    <div class="border py-20 my-2" data-aos="fade-down">aos</div>
    <div class="border py-20 my-2" data-aos="fade-up">aos</div>
  </div>
</template>
